...
public class EnemyHealthViewsController : MonoBehaviour
{
    ...
    private void Init()
    {
        ...
        // Присваиваем _enemySpawner объект типа EnemySpawner
        _enemySpawner = FindAnyObjectByType<EnemySpawner>();

        // Создаём шкалы здоровья существующим врагам
        CreateViewsForExistingEnemies();

        // Подписываемся на будущих врагов
